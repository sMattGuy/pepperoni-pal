...
sequelize.sync({ force, alter }).then(async () => {
	...
	*/
	const personalities = [
		...
		personality.upsert({id: 2,name: 'Light Eater',hungerMod: 1.5,happinessMod: 0,cleanlinessMod: 0,sickMod: 0,special: 'Peckish', specialDescription: 'Battle: Deal an additional 2 Damage (+1 per 2 level) for this turn'}), //attack
		personality.upsert({id: 3,name: 'Heavy Eater',hungerMod: -1.5,happinessMod: 0,cleanlinessMod: 0,sickMod: 0,special: 'Devoure', specialDescription: 'Battle: Deal an additional 4 Damage (+1 per 2 levels) for this turn'}), //attack
		...
		personality.upsert({id: 8,name: 'Immune',hungerMod: 0,happinessMod: 0,cleanlinessMod: 0,sickMod: -1.5,special: 'Survivalist', specialDescription: 'Battle: Get a 1 in 6 chance (+1 per level, capped at 3) to run away'}), //special
		personality.upsert({id: 9,name: 'Weak',hungerMod: 0,happinessMod: 0,cleanlinessMod: 0,sickMod: 1.5,special: 'Diseased', specialDescription: 'Battle: Deal 3 Damage over 3 (+1 per 2 levels) turns'}), //special
