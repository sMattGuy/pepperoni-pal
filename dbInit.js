...
sequelize.sync({ force, alter }).then(async () => {
	...
	*/
	const personalities = [
		...
		personality.upsert({id: 8,name: 'Immune',hungerMod: 0,happinessMod: 0,cleanlinessMod: 0,sickMod: -1.5,special: 'Survivalist', specialDescription: 'Battle: Get a 1 (+1 per level, capped at 3) in 6 chance  to run away'}), //special
		personality.upsert({id: 9,name: 'Weak',hungerMod: 0,happinessMod: 0,cleanlinessMod: 0,sickMod: 1.5,special: 'Diseased', specialDescription: 'Battle: Deal 1 Damage for 3 (+1 per 2 levels) turns'}), //special
